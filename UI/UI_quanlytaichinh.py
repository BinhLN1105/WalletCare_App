...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/newPrefix/icon/menu.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon.addFile(u":/newPrefix/icon/menu_blue.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/newPrefix/icon/question_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/newPrefix/icon/information_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        ...
        icon3 = QIcon()
        icon3.addFile(u":/newPrefix/icon/pie-chart.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon3.addFile(u":/newPrefix/icon/pie-chart_while.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/newPrefix/icon/bar-chart.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon4.addFile(u":/newPrefix/icon/bar_white.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
...
"")
        icon5 = QIcon()
        icon5.addFile(u":/newPrefix/icon/idea.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon5.addFile(u":/newPrefix/icon/idea_blue.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.goiy_btn.setIcon(icon5)
        self.goiy_btn.setIconSize(QSize(25, 25))
...
"	\n"
"	border-image: url(:/newPrefix/icon/GYTK_bg.png)10 10 10 10 stretch stretch;\n"
"	border:none;\n"
"}\n"
"")
        ...
        self.label.setPixmap(QPixmap(u":/newPrefix/icon/big_icon.png"))
        ...
        icon6 = QIcon()
        icon6.addFile(u":/newPrefix/icon/quanlychitieu_white.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon6.addFile(u":/newPrefix/icon/quanlychitieu_blue.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.quanlichiteu_Btn1.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/newPrefix/icon/growth_white.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon7.addFile(u":/newPrefix/icon/growth_blue.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.phantichchiteu_Btn1.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/newPrefix/icon/idea_white.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon8.addFile(u":/newPrefix/icon/idea_blue.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.goiytietkiem_Btn1.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/newPrefix/icon/settings_white.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon9.addFile(u":/newPrefix/icon/settings.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.setting_Btn1.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/newPrefix/icon/close_white.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon10.addFile(u":/newPrefix/icon/close_blue.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.close_Btn1.setIcon(icon10)
        ...
        self.label_2.setPixmap(QPixmap(u":/newPrefix/icon/big_icon.png"))
        ...
        self.quanlichiteu_Btn2.setIcon(icon6)
        ...
        self.phantichchiteu_Btn2.setIcon(icon7)
        ...
        self.goiytietkiem_Btn2.setIcon(icon8)
        ...
        self.setting_Btn2.setIcon(icon9)
        ...
        self.close_Btn2.setIcon(icon10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.timchitieu_lineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"T\u00ecm chi ti\u00eau theo t\u00ean chi ti\u00eau...", None))
